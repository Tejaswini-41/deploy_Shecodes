...
const MENTOR_API_URL = "http://54.167.8.61/api/mentors";
...
const Mentorship = () => {
  ...
  const [mentorForm, setMentorForm] = useState({
    ...
    linkedinUrl: "",
    avatar:
      "https://cdn.prod.website-files.com/5ce11396d0cadb67eb2cac0e/621e3dddf8077a0ce7a409ba_Professional%20mentor.pngg",
    imageFile: null,
  });
  ...
  const fetchMentors = async () => {
    ...
    try {
      ...
      setError(
        "Failed to load mentors. Please check if the server is running."
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleMentorSubmit = async (e) => {
    ...
    try {
      ...
      formData.append(
        "linkedinUrl",
        mentorForm.linkedinUrl || "https://www.linkedin.com/in/"
      );
              ...
              <button
                ...
                onClick={() =>
                  (window.location.href =
                    mentor.linkedinUrl || "https://www.linkedin.com/")
                }
              >
                Connect
              </button>
